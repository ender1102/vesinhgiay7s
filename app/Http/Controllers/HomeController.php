...
class HomeController extends Controller
{
    ...
    public function index(){
        ...
        $loaimon = DB::table('loaimonan')->get();
    ...
    public function xulydatban(Request $request)
    {
        ...
        if($ThoiGian < $now){
            Session::flash('alert-failed','Đặt bàn thất bại, ngày đặt không hợp lệ !');
            ...
            // dd('done');
            Session::flash('alert-order','Đặt bàn thành công ! Quý khách vui lòng đợi nhân viên gọi điện thoại xác nhận và duyệt bàn (Có thể xem thông tin ở lịch sử đặt bàn )');
            return redirect()->back();
        }
    }
