        ...
        <div class="col-md-12 col-sm-12  ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>
                        {{-- Thông báo --}}
                        <span class="fa fa-bullhorn" style="color:red"> Tìm thấy {{count($timkiem_khachhang)}} kết quả</span>
                    </h2>
                ...
                <div class="x_content">
                    ...
                    <div class="table-responsive">
                        ...
                        @foreach ($timkiem_khachhang as $key => $timkiem)
                            ...
                            <tbody>
                                <tr class="even pointer">
                                    ...
                                    <td>{{$timkiem->TenKH}}</td>
                                    <td>{{$timkiem->SdtKH}}</td>
                                    <td>{{$timkiem->GioiTinhKH}}</td>
                                    <td>{{ Carbon\Carbon::parse($timkiem->SinhNhatKH)->format('d/m/Y') }}</td>
                                    <td>{{$timkiem->FbKH}}</td>
                                    <td>{{$timkiem->TichLuyKH}}</td>
                                    <td style="text-align: center">
                                        <a href="{{URL::to('/sua-khachhang/'.$timkiem->IdKH)}}" class="active styling-edit" ui-toggle-class="">
                                            <i class="fa fa-pencil-square-o text-success text-active"></i>
                                        </a>
                                    </td>
                                    <td style="text-align: center">
                                        <a onclick="return confirm('Bạn có chắc chắn xoá không?')" href="{{URL::to('/xoa-khachhang/'.$timkiem->IdKH)}}" class="active styling-delete" ui-toggle-class="">
